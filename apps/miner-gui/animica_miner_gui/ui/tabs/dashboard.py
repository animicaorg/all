...
class DashboardTab(QWidget):
    ...
    def setup_rpc_timer(self) -> None:
        ...
        # RPC client comes from node_manager
    ...
    def update_chain_info(self) -> None:
        ...
        try:
            head = rpc_client.get_chain_head()
            ...
            try:
                ...
                if sync_status.syncing:
                    self.sync_label.setText(f"Syncing: {sync_status.current_height}/{sync_status.best_height}")
                else:
    ...
    def refresh_balance(self) -> None:
        ...
        try:
            balance = rpc_client.get_balance(payout_address)
