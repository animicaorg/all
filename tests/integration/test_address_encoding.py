...
class TestAddressToBytes:
    ...
    def test_bech32_address(self):
        ...
        addr = "anim1zqp2nx50902d7jgrzk0ep798r2vhpgt3rhtmn89gadzdgyhf9hmln7g9e4xt9"
        result = address_to_bytes(addr)
    ...
    def test_bech32_address_case_insensitive(self):
        ...
        addr_lower = "anim1zqp2nx50902d7jgrzk0ep798r2vhpgt3rhtmn89gadzdgyhf9hmln7g9e4xt9"
...
class TestAddressEncodingConsistency:
    ...
    def test_bech32_addresses_different(self):
        ...
        addr1 = "anim1zqp2nx50902d7jgrzk0ep798r2vhpgt3rhtmn89gadzdgyhf9hmln7g9e4xt9"
