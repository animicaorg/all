...
def score_block(block_hash: bytes, height: int, timestamp: int, difficulty: int = 0, miner: bytes | None = None) -> dict:
    ...
    composite = ((digest & 0xFF) << 24) | ((miner_checksum & 0xFF) << 16) | ((parity & 0xFF) << 8) | (score & 0xFF)
