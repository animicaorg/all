---
title: "Animica L2 — Running a Node"
...
| `ANIMICA_L2_SETTLEMENT_MODE` | `VALIDITY` | `VALIDITY` \| `OPTIMISTIC` \| `DEV` (see [SECURITY_ASSUMPTIONS.md](/docs/l2/security-assumptions)); an unknown value falls back to `VALIDITY` |
...
| `animica l2 bench …` | in-process (`l2/bench.py`) | Deterministic benchmark harness on an ephemeral devnet node — never touches real state; see [PERFORMANCE.md](/docs/l2/performance) |
