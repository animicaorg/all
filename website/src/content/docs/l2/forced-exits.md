---
title: "Animica L2 — Forced Inclusion & Forced Exits"
...
*Source: `docs/l2/FORCED_EXITS.md` — this page mirrors the repository documentation.*
...
[SECURITY_ASSUMPTIONS.md](/docs/l2/security-assumptions).
