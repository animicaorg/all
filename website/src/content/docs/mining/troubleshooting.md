---
title: "Mining Troubleshooting Guide"
...
*Source: `docs/MINING_TROUBLESHOOTING.md` — this page mirrors the repository documentation.*
...
⚠️ **Important**: As of the P2P-first update, mining uses local P2P validation by default (no proxy). See [P2P Sync Guide](https://github.com/animicaorg/all/blob/main/docs/p2p_sync.md) for P2P troubleshooting.
