...
# This matches the hash generated by core/genesis/loader.compute_genesis_hash for chain_id=1
    ...
    *,
    ...
    if resolved_path:
        try:
            ...
            found_hex = compute_genesis_hash(resolved_path)
        except Exception:
            pass
    ...
    if genesis_block_hash != expected:
        raise GenesisError(
            ...
            hint=(
                ...
                "Possible fixes:\n"
                "- You may be running the wrong network configuration.\n"
                "- If the genesis file changed intentionally, update the pinned hash.\n"
                "- Wipe or reset the /data volume if it contains an old genesis DB."
            ),
        )
