...
# Current: 0xd2d2897104110b86bb60ccec251a7e2313f4abb301f8cc532d60162c20d3644f (2026-01-18)
# This matches the hash generated by consensus/build_genesis.py for chain_id=1
MAINNET_GENESIS_HASH_HEX = (
    "0xd2d2897104110b86bb60ccec251a7e2313f4abb301f8cc532d60162c20d3644f"
)
    ...
    if genesis_block_hash != expected:
        raise GenesisError(
            ...
            hint=(
                ...
                "You may be running the wrong network or the genesis file changed. "
                "If this is a planned reset, update PINNED_GENESIS_BY_NETWORK and the "
                "genesis metadata. Otherwise point to the correct network genesis file. "
                "If your /data volume already contains the old genesis DB, wipe it or "
                "use the reset command to reinitialize."
            ),
        )
