...
from . import aicf, chain, da, debug, faucet, gui, key, mempool, mining, network, node, p2p, peer, rpc, script, snapshot, studio, sync, tx, wallet
...
app.add_typer(aicf.app, name="aicf")
