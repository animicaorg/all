...
1. **Trusted verifier nodes** are designated by IP address (default: `62.169.17.132`, `82.208.20.209`, `3.12.224.189`).
...
```bash
export ANIMICA_P2P_VERIFIER_SEED_IPS="62.169.17.132,82.208.20.209,3.12.224.189"
```
