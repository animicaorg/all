...
DEFAULT_MAX_IN_FLIGHT: int = 1024  # Increased from 256 for faster sync (500+ blocks/min target)
DEFAULT_REQUEST_TIMEOUT_SEC: float = 10.0  # Increased from 6.0 for larger batch handling
