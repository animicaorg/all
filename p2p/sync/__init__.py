...
DEFAULT_MAX_IN_FLIGHT: int = 1024  # Increased from 256 to improve parallelism and throughput
DEFAULT_REQUEST_TIMEOUT_SEC: float = 10.0  # Increased from 6.0 to handle larger batch sizes
